...
public class MainPage {
    ...
    public By closeTab = By.xpath("(//button[contains(@class,\"Modal_modal__close_modified__3V5XS\")])[1]");
    ...
    public WebElement getCloseTab() {
        WebElement x = new WebDriverWait(driver, Duration.ofSeconds(3)).until(ExpectedConditions.visibilityOfElementLocated(closeTab));
        return x;
    }
}
